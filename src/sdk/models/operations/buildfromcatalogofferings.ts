...
export class BuildFromCatalogOfferingsRequest extends SpeakeasyBase {
    ...
    offerQueryBuildFromCatalogOfferingsHospitalityWrapper: shared.OfferQueryBuildFromCatalogOfferingsHospitalityWrapper;
     ...
     */
    @SpeakeasyMetadata({ data: "header, style=simple;explode=false;name=TravelportPlusSessionID" })
...
export class BuildFromCatalogOfferingsResponse extends SpeakeasyBase {
    /**
